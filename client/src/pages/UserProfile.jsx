...
export default function UserProfile() {
    ...
    useEffect(() => {
        ...
        const fetchProfile = async () => {
            ...
            try {
                ...
                const allAchResponse = await fetch("/api/achievements/");
                let globalAch = [];
    ...
    if (loading) {
        return <div className={styles.loading}>Se încarcă profilul...</div>;
    }
        ...
        return (
            <div className={styles.error}>
                ...
                <p style={{ fontSize: "14px", marginTop: "10px", color: "#8f98a0" }}>
                    Asigură-te că ești autentificat pentru a accesa profilul.
                </p>
            </div>
        );
    }
        ...
        <div className={styles.container}>
            <div className={styles.profileCard}>
                                    ...
                                    <div key={order.id} className={styles.orderRow}>
                                        ...
                                        <div className={styles.orderDetailsGrid}>
                                            ...
                                            <div className={styles.orderDetailCol}>
                                                ...
                                                <span className={styles.detailValue}>{parseFloat(order.total).toFixed(2)} €</span>
                                            </div>
                                            <div className={styles.orderDetailCol}>
                                                <span className={styles.detailLabel}>Statut</span>
                                                <span className={styles.detailStatus}>
                                                    {order.status === 'confirmed' ? 'Confirmat' :
                                                     order.status === 'shipped' ? 'Expediat' :
                                                     order.status === 'delivered' ? 'Livrat' :
                                                     order.status === 'cancelled' ? 'Anulat' : 'În așteptare'}
                                                </span>
                                            </div>
                ...
                <div className={styles.achievementsSection}>
                    <h2 className={styles.sectionTitle}>Achievement-uri</h2>
                    ...
                    <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="receipt-details bg-dark p-4 rounded mb-4 border border-secondary border-opacity-25 shadow-sm">
                            ...
                            <div className="d-flex justify-content-between mb-2">
                                ...
                                <span className="text-white">{parseFloat(selectedOrder.total).toFixed(2)} €</span>
                            </div>

                            <div className="d-flex justify-content-between mt-3 pt-3 border-top border-secondary border-opacity-50">
                                <strong className="text-white">Total</strong>
                                <strong className="text-white fs-5">{parseFloat(selectedOrder.total).toFixed(2)} €</strong>
                            </div>
                        </div>
