        ...
        <div className="col-lg-7">
          ...
          <div className="mb-3 d-flex align-items-center gap-3 flex-wrap">
            ...
            {reviews.length > 0 && averageRating !== null && (
              <div className="d-flex align-items-center gap-2">
                <span className="text-warning" style={{ letterSpacing: '2px', fontSize: '1rem' }}>
                  {"★".repeat(Math.round(averageRating))}{"☆".repeat(5 - Math.round(averageRating))}
                </span>
                <span className="text-muted small">{averageRating}/5 ({reviews.length} {reviews.length === 1 ? "recenzie" : "recenzii"})</span>
              </div>
            )}
          </div>
          ...
          <div className="d-flex flex-wrap gap-3 mb-4">
            <button className="btn btn-primary btn-lg px-5 py-3 fw-bold shadow position-relative overflow-hidden"
              ...
              <i className="bi bi-cart-plus me-2 fs-5"></i> {product.stock === 0 ? "Epuizat" : "Adaugă în coș"}
            </button>
          ...
          <div className="d-flex align-items-center gap-3">
            {product.stock > 0 ? (
              <p className="small mb-0 text-success fw-bold d-flex align-items-center">
                <i className="bi bi-check-circle-fill me-2 fs-5"></i> În stoc ({product.stock} buc.)
              </p>
            ) : (
              <p className="small mb-0 text-danger fw-bold d-flex align-items-center">
                <i className="bi bi-x-circle-fill me-2 fs-5"></i> Epuizat
              </p>
            )}
