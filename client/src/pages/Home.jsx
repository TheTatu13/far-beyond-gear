  ...
  return (
    <div style={{ backgroundColor: '#0c0804' }}>
      ...
      <section style={{
        ...
        >
          <source src="/assets/video/cover hero licenta.mp4" type="video/mp4" />
          {/* Fallback la imaginea statică dacă browserul nu suportă video */}
          <img src="/assets/img/fire_stage.jpg" alt="Metal concert pyro" style={{ width:"100%", height:"100%", objectFit:"cover" }} />
        </video>
